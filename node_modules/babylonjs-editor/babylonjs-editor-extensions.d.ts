...
declare module 'babylonjs-editor' {
    ...
    import GraphExtension from 'babylonjs-editor/behavior/graph';
    import PathFinderExtension from 'babylonjs-editor/path-finder/index';
    import ParticlesCreatorExtension from 'babylonjs-editor/particles-creator/particles-creator';
    ...
    export { Extensions, Extension, CodeExtension, GraphExtension, PostProcessExtension, MaterialEditorExtension, PathFinderExtension, PostProcessEditorExtension, ParticlesCreatorExtension, CustomMetadatasExtension, IExtension, ExtensionConstructor };
}
...
declare module 'babylonjs-editor/particles-creator/particles-creator' {
    import { Scene } from 'babylonjs';
    import Extension from 'babylonjs-editor/extension';
    import { IStringDictionary } from 'babylonjs-editor/typings/typings';
    ...
    export default class ParticlesCreatorExtension extends Extension<ParticlesCreatorMetadata[]> {
            ...
            /**
                * On apply the extension
                */
            onApply(data: ParticlesCreatorMetadata[], rootUrl?: string): void;
            /**
                * Called by the editor when serializing the scene
                */
            onSerialize(): ParticlesCreatorMetadata[];
            /**
                * On load the extension (called by the editor when
                * loading a scene)
                */
            onLoad(data: ParticlesCreatorMetadata[]): void;
    }
}
